export default function PrivacyPolicy() {
  return (
    <div className="p-10 xl:p-20">
      ...
      <br />
      <h2 className="text-4xl">Interpretation and Definitions</h2>
      <br />
      <br />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Foo MTS.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Foo MTS, accessible from{' '}
            <a
              href="https://foo.magictechsolutions.dev"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://foo.magictechsolutions.dev
            </a>
          </p>
        </li>
        <li>
      ...
      <br />
      <h2 className="text-4xl">Collecting and Using Your Personal Data</h2>
      <br />
      ...
      <br />
      <h3 className="text-2xl">Use of Your Personal Data</h3>
      <br />
      ...
      <br />
      <h3 className="text-2xl">Retention of Your Personal Data</h3>
      <br />
      <p>
      ...
      <br />
      <h3 className="text-2xl">Transfer of Your Personal Data</h3>
      <br />
      <p>
      ...
      <br />
      <h3 className="text-2xl">Delete Your Personal Data</h3>
      <br />
      <p>
      ...
      <br />
      <h3 className="text-2xl">Disclosure of Your Personal Data</h3>
      <br />
      ...
      <br />
      <h3 className="text-2xl">Security of Your Personal Data</h3>
      <br />
      <p>
      ...
      <br />
      <h2 className="text-4xl">Children&apos;s Privacy</h2>
      <br />
      <p>
      ...
      <br />
      <h2 className="text-4xl">Changes to this Privacy Policy</h2>
      <br />
      <p>
      ...
      <ul>
        <li>By email: support@magictechsolutions.dev</li>
      </ul>
    </div>
  );
}
